...
def main():
    ...
    st.header("Chat with GreenZ")
    user_question = st.text_input("GreenZ will help you with your questions", placeholder="Ask your question here")

    # if local vector store is not present then load it
